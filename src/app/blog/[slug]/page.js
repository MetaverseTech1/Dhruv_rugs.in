      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 md:p-12">
        ...
        <div className="mt-16 pt-10 border-t border-white/30">
          <div className="text-center max-w-lg mx-auto">
            <h3 className="text-white text-2xl font-bold mb-8">Share this article</h3>
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <svg className="w-6 h-6 flex-shrink-0 relative z-10" fill="currentColor" viewBox="0 0 24 24">
